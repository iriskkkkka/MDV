...
VL_INLINE_OPT void Vfibonacci_generator___024root___nba_sequent__TOP__0(Vfibonacci_generator___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    QData/*63:0*/ __Vdly__fibonacci_generator__DOT__fib_prev1;
    __Vdly__fibonacci_generator__DOT__fib_prev1 = 0;
    QData/*63:0*/ __Vdly__fibonacci_generator__DOT__fib_prev2;
    ...
    if (vlSelfRef.rst) {
        __Vdly__fibonacci_generator__DOT__fib_prev1 = 1ULL;
        __Vdly__fibonacci_generator__DOT__fib_prev2 = 0ULL;
        vlSelfRef.fib_out = 0ULL;
