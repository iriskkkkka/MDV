...
VL_ATTR_COLD void Vfibonacci_generator___024root___ctor_var_reset(Vfibonacci_generator___024root* vlSelf) {
    ...
    vlSelf->fib_out = VL_RAND_RESET_Q(64);
    vlSelf->fibonacci_generator__DOT__fib_prev1 = VL_RAND_RESET_Q(64);
    vlSelf->fibonacci_generator__DOT__fib_prev2 = VL_RAND_RESET_Q(64);
