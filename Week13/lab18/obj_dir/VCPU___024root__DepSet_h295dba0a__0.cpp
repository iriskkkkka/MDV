...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.CPU__DOT__core__DOT__control_unit_init__DOT__state 
            = (((IData)(vlSelfRef.CPU__DOT__runi) & (IData)(vlSelfRef.CPU__DOT__runo))
                ? (IData)(vlSelfRef.CPU__DOT__core__DOT__control_unit_init__DOT__next_state)
    ...
    vlSelfRef.CPU__DOT__runi = ((IData)(vlSelfRef.rst) 
