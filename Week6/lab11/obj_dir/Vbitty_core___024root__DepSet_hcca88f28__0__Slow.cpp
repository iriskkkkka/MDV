...
VL_ATTR_COLD void Vbitty_core___024root___ctor_var_reset(Vbitty_core___024root* vlSelf) {
    ...
    vlSelf->example = VL_RAND_RESET_I(16);
    ...
    vlSelf->bitty_core__DOT__alu_init__DOT__logic_res = VL_RAND_RESET_I(16);
    vlSelf->bitty_core__DOT__alu_init__DOT__arithmetic_res = VL_RAND_RESET_I(16);
