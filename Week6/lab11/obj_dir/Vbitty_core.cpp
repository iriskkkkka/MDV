...
Vbitty_core::Vbitty_core(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , example{vlSymsp->TOP.example}
    , debug_reginst_out{vlSymsp->TOP.debug_reginst_out}
    , debug_sreg_out{vlSymsp->TOP.debug_sreg_out}
    , debug_creg_out{vlSymsp->TOP.debug_creg_out}
