...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__0(Vbitty_core___024root* vlSelf) {
    ...
    // Body
    if (vlSelfRef.rst) {
        vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state = 0U;
        vlSelfRef.example = 0U;
    } else {
        vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state 
            = ((IData)(vlSelfRef.run) ? (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__next_state)
                : (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state));
        vlSelfRef.example = vlSelfRef.bitty_core__DOT__creg_out;
    }
    vlSelfRef.done = 0U;
...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__1(Vbitty_core___024root* vlSelf) {
    ...
    if ((0x80U & (IData)(vlSelfRef.bitty_core__DOT__en))) {
        vlSelfRef.bitty_core__DOT____Vcellout__reg7__d_out = 0xabcdU;
    }
    ...
    if (vlSelfRef.rst) {
        ...
        if (vlSelfRef.bitty_core__DOT__enc) {
            vlSelfRef.bitty_core__DOT__creg_out = ((IData)(vlSelfRef.bitty_core__DOT__mode)
                                                    ? (IData)(vlSelfRef.bitty_core__DOT__alu_init__DOT__logic_res)
                                                    : (IData)(vlSelfRef.bitty_core__DOT__alu_init__DOT__arithmetic_res));
        }
    }
...
VL_INLINE_OPT void Vbitty_core___024root___nba_comb__TOP__0(Vbitty_core___024root* vlSelf) {
    ...
    CData/*3:0*/ bitty_core__DOT__control_unit_init__DOT__alusel;
    bitty_core__DOT__control_unit_init__DOT__alusel = 0;
    CData/*0:0*/ bitty_core__DOT__control_unit_init__DOT__modesel;
    bitty_core__DOT__control_unit_init__DOT__modesel = 0;
    // Body
    bitty_core__DOT__control_unit_init__DOT__alusel 
        = (0xfU & ((IData)(vlSelfRef.bitty_core__DOT__reginst_out) 
                   >> 3U));
    ...
    bitty_core__DOT__control_unit_init__DOT__modesel 
        = (1U & ((IData)(vlSelfRef.bitty_core__DOT__reginst_out) 
                 >> 2U));
    vlSelfRef.bitty_core__DOT__mode = 0U;
    if ((2U & (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state))) {
        if ((1U & (~ (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state)))) {
            bitty_core__DOT__alu_sel = bitty_core__DOT__control_unit_init__DOT__alusel;
            vlSelfRef.bitty_core__DOT__mode = bitty_core__DOT__control_unit_init__DOT__modesel;
        }
        if ((1U & (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state))) {
        ...
        if ((4U & (IData)(bitty_core__DOT__alu_sel))) {
            if ((2U & (IData)(bitty_core__DOT__alu_sel))) {
                if ((1U & (IData)(bitty_core__DOT__alu_sel))) {
                    vlSelfRef.bitty_core__DOT__alu_init__DOT__logic_res 
                        = (0xffffU & (IData)(vlSelfRef.bitty_core__DOT__sreg_out));
                    vlSelfRef.bitty_core__DOT__alu_init__DOT__arithmetic_res 
                        = (0xffffU & ((IData)(vlSelfRef.bitty_core__DOT__sreg_out) 
                                      - (IData)(1U)));
                } else {
                    vlSelfRef.bitty_core__DOT__alu_init__DOT__logic_res 
