...
VL_ATTR_COLD void Vbitty_core___024root___ctor_var_reset(Vbitty_core___024root* vlSelf) {
    ...
    vlSelf->bitty_core__DOT__mux_sel = VL_RAND_RESET_I(4);
    ...
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->bitty_core__DOT____Vcellinp__dpi_init__reg_written[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->bitty_core__DOT__control_unit_init__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__next_state = VL_RAND_RESET_I(3);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__addrx = VL_RAND_RESET_I(3);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__addry = VL_RAND_RESET_I(3);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__alusel = VL_RAND_RESET_I(3);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__immediate = VL_RAND_RESET_I(8);
    vlSelf->bitty_core__DOT__control_unit_init__DOT__format = VL_RAND_RESET_I(2);
