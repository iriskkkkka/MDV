...
VCPU::VCPU(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , addr_newe{vlSymsp->TOP.addr_newe}
    , donee{vlSymsp->TOP.donee}
    , addr_olde{vlSymsp->TOP.addr_olde}
    , runs{vlSymsp->TOP.runs}
    , rx{vlSymsp->TOP.rx}
    , ry{vlSymsp->TOP.ry}
    , ls_ine{vlSymsp->TOP.ls_ine}
    , reg_oute{vlSymsp->TOP.reg_oute}
