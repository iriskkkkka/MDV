...
VL_ATTR_COLD void VCPU___024root___eval_static__TOP(VCPU___024root* vlSelf) {
    ...
    vlSelfRef.CPU__DOT__ldst__DOT__initialized = 0U;
}
...
VL_ATTR_COLD void VCPU___024root___eval_initial__TOP(VCPU___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((0U != vlSelfRef.CPU__DOT__ldst__DOT__file)))) {
        vlSelfRef.CPU__DOT__ldst__DOT__unnamedblk1__DOT__i = 0U;
        vlSelfRef.CPU__DOT__ldst__DOT__initialized = 1U;
        while (VL_GTS_III(32, 0x10000U, vlSelfRef.CPU__DOT__ldst__DOT__unnamedblk1__DOT__i)) {
            vlSelfRef.CPU__DOT__ldst__DOT__memory[(0xffffU 
                                                   & vlSelfRef.CPU__DOT__ldst__DOT__unnamedblk1__DOT__i)] 
                = ((1U == VL_FSCANF_INX(vlSelfRef.CPU__DOT__ldst__DOT__file,"%04x\n",0,
                                        16,&(vlSelfRef.CPU__DOT__ldst__DOT__temp_data)) )
                    ? (IData)(vlSelfRef.CPU__DOT__ldst__DOT__temp_data)
                    : 0U);
            vlSelfRef.CPU__DOT__ldst__DOT__unnamedblk1__DOT__i 
                = ((IData)(1U) + vlSelfRef.CPU__DOT__ldst__DOT__unnamedblk1__DOT__i);
        }
...
VL_ATTR_COLD void VCPU___024root___ctor_var_reset(VCPU___024root* vlSelf) {
    ...
    vlSelf->addr_newe = VL_RAND_RESET_I(8);
    vlSelf->donee = VL_RAND_RESET_I(1);
    vlSelf->addr_olde = VL_RAND_RESET_I(8);
    for (int __Vi0 = 0; __Vi0 < 9; ++__Vi0) {
        vlSelf->reg_oute[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->runs = VL_RAND_RESET_I(1);
    vlSelf->ls_ine = VL_RAND_RESET_I(16);
    vlSelf->rx = VL_RAND_RESET_I(4);
    vlSelf->ry = VL_RAND_RESET_I(4);
    vlSelf->CPU__DOT__instr = VL_RAND_RESET_I(16);
    vlSelf->CPU__DOT__addr_old = VL_RAND_RESET_I(8);
    vlSelf->CPU__DOT__addr_new = VL_RAND_RESET_I(8);
    vlSelf->CPU__DOT__done = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__runo = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__runi = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__ls_in = VL_RAND_RESET_I(16);
    ...
    vlSelf->CPU__DOT__core__DOT__sel_ls = VL_RAND_RESET_I(1);
    ...
    vlSelf->CPU__DOT__core__DOT__enls = VL_RAND_RESET_I(1);
    ...
    vlSelf->CPU__DOT__core__DOT__ls_out = VL_RAND_RESET_I(16);
    ...
    vlSelf->CPU__DOT__core__DOT__control_unit_init__DOT__ls = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__ldst__DOT__file = 0;
    vlSelf->CPU__DOT__ldst__DOT__temp_data = VL_RAND_RESET_I(16);
    for (int __Vi0 = 0; __Vi0 < 65536; ++__Vi0) {
        vlSelf->CPU__DOT__ldst__DOT__memory[__Vi0] = VL_RAND_RESET_I(16);
    }
    vlSelf->CPU__DOT__ldst__DOT__initialized = VL_RAND_RESET_I(1);
    vlSelf->CPU__DOT__ldst__DOT__unnamedblk1__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->CPU__DOT__ldst__DOT__unnamedblk2__DOT__i = VL_RAND_RESET_I(32);
