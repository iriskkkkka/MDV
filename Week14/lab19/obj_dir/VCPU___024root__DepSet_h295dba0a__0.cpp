...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.CPU__DOT__addr_old = 0U;
    } else {
        vlSelfRef.CPU__DOT__core__DOT__control_unit_init__DOT__state 
            = ((IData)(vlSelfRef.runs) ? (IData)(vlSelfRef.CPU__DOT__core__DOT__control_unit_init__DOT__next_state)
                : (IData)(vlSelfRef.CPU__DOT__core__DOT__control_unit_init__DOT__state));
        vlSelfRef.CPU__DOT__addr_old = (0xffU & ((IData)(vlSelfRef.CPU__DOT__done)
                                                  ? 
                                                 ((IData)(1U) 
                                                  + (IData)(vlSelfRef.CPU__DOT__addr_new))
                                                  : (IData)(vlSelfRef.CPU__DOT__addr_new)));
    }
    vlSelfRef.CPU__DOT__runi = ((1U & (~ (IData)(vlSelfRef.rst))) 
                                && (1U & (~ (IData)(vlSelfRef.CPU__DOT__done))));
    ...
    vlSelfRef.addr_olde = vlSelfRef.CPU__DOT__addr_old;
}
...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__1(VCPU___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.CPU__DOT__core__DOT__ls_out = 0U;
    } else {
        ...
        if (vlSelfRef.CPU__DOT__core__DOT__enc) {
            vlSelfRef.CPU__DOT__core__DOT__creg_out 
                = (0xffffU & ((IData)(vlSelfRef.CPU__DOT__core__DOT__sel_ls)
                               ? (IData)(vlSelfRef.CPU__DOT__core__DOT__ls_out)
                               : ((4U & (IData)(vlSelfRef.CPU__DOT__core__DOT__alu_sel))
        ...
        if (vlSelfRef.CPU__DOT__core__DOT__enls) {
            vlSelfRef.CPU__DOT__core__DOT__ls_out = vlSelfRef.CPU__DOT__ls_in;
        }
    }
    vlSelfRef.CPU__DOT__instr = vlSelfRef.CPU__DOT__mem__DOT__mem
        [vlSelfRef.CPU__DOT__addr_new];
    ...
    vlSelfRef.rx = (7U & ((IData)(vlSelfRef.CPU__DOT__instr) 
                          >> 0xdU));
    vlSelfRef.ry = (7U & ((IData)(vlSelfRef.CPU__DOT__instr) 
                          >> 0xaU));
}
