...
Vbitty_core::Vbitty_core(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , debug_reg0_out{vlSymsp->TOP.debug_reg0_out}
    , debug_reg1_out{vlSymsp->TOP.debug_reg1_out}
    , debug_reg2_out{vlSymsp->TOP.debug_reg2_out}
    , debug_reg3_out{vlSymsp->TOP.debug_reg3_out}
    , debug_reg4_out{vlSymsp->TOP.debug_reg4_out}
    , debug_reg5_out{vlSymsp->TOP.debug_reg5_out}
    , debug_reg6_out{vlSymsp->TOP.debug_reg6_out}
    , debug_reg7_out{vlSymsp->TOP.debug_reg7_out}
    , rootp{&(vlSymsp->TOP)}
{
