...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__1(Vbitty_core___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.bitty_core__DOT____Vcellout__reg0__d_out = 0U;
        ...
        vlSelfRef.bitty_core__DOT____Vcellout__reg7__d_out = 0U;
        ...
        if ((0x80U & (IData)(vlSelfRef.bitty_core__DOT__en))) {
            vlSelfRef.bitty_core__DOT____Vcellout__reg7__d_out 
                = vlSelfRef.bitty_core__DOT__creg_out;
        }
