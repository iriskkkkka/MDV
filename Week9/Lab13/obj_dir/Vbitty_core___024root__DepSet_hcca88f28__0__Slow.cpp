...
VL_ATTR_COLD void Vbitty_core___024root___stl_sequent__TOP__0(Vbitty_core___024root* vlSelf) {
    ...
    bitty_core__DOT__control_unit_init__DOT__immediate = 0;
    CData/*1:0*/ bitty_core__DOT__control_unit_init__DOT__format;
    bitty_core__DOT__control_unit_init__DOT__format = 0;
    CData/*1:0*/ __Vtableidx1;
    __Vtableidx1 = 0;
    // Body
    vlSelfRef.debug_reg0_out = vlSelfRef.bitty_core__DOT____Vcellout__reg0__d_out;
    vlSelfRef.debug_reg1_out = vlSelfRef.bitty_core__DOT____Vcellout__reg1__d_out;
    vlSelfRef.debug_reg2_out = vlSelfRef.bitty_core__DOT____Vcellout__reg2__d_out;
    vlSelfRef.debug_reg3_out = vlSelfRef.bitty_core__DOT____Vcellout__reg3__d_out;
    vlSelfRef.debug_reg4_out = vlSelfRef.bitty_core__DOT____Vcellout__reg4__d_out;
    vlSelfRef.debug_reg5_out = vlSelfRef.bitty_core__DOT____Vcellout__reg5__d_out;
    vlSelfRef.debug_reg6_out = vlSelfRef.bitty_core__DOT____Vcellout__reg6__d_out;
    vlSelfRef.debug_reg7_out = vlSelfRef.bitty_core__DOT____Vcellout__reg7__d_out;
    ...
    bitty_core__DOT__control_unit_init__DOT__alusel 
        = (7U & ((IData)(vlSelfRef.bitty_core__DOT__reginst_out) 
                 >> 2U));
    bitty_core__DOT__control_unit_init__DOT__immediate 
        = (0xffU & ((IData)(vlSelfRef.bitty_core__DOT__reginst_out) 
                    >> 5U));
    bitty_core__DOT__control_unit_init__DOT__format 
    ...
    vlSelfRef.done = 0U;
    if ((0U == (IData)(bitty_core__DOT__control_unit_init__DOT__format))) {
    ...
    } else if ((1U == (IData)(bitty_core__DOT__control_unit_init__DOT__format))) {
        if ((2U & (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state))) {
            if ((1U & (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state))) {
                vlSelfRef.bitty_core__DOT__en = (0xffU 
                                                 & ((IData)(1U) 
                ...
                vlSelfRef.bitty_core__DOT__enc = 1U;
                vlSelfRef.bitty_core__DOT__imdt = bitty_core__DOT__control_unit_init__DOT__immediate;
                bitty_core__DOT__mux_sel = 8U;
                vlSelfRef.bitty_core__DOT__alu_sel 
                    = bitty_core__DOT__control_unit_init__DOT__alusel;
            }
        } else if ((1U & (IData)(vlSelfRef.bitty_core__DOT__control_unit_init__DOT__state))) {
...
VL_ATTR_COLD void Vbitty_core___024root___ctor_var_reset(Vbitty_core___024root* vlSelf) {
    ...
    vlSelf->debug_reg1_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg2_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg3_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg4_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg5_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg6_out = VL_RAND_RESET_I(16);
    vlSelf->debug_reg7_out = VL_RAND_RESET_I(16);
    ...
    vlSelf->bitty_core__DOT__imdt = VL_RAND_RESET_I(16);
